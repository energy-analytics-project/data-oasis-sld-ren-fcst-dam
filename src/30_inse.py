...
DATABASE        = "data-oasis-sld-ren-fcst-dam.db"
...
# resource name
# -----------------------------------------------------------------------------
RESOURCE_NAME           = "data-oasis-sld-ren-fcst-dam"
RESOURCE_NS             = "http://www.caiso.com/soa/OASISReport_v1.xsd"
...
def entry(header, name, item):
    return {
        ...
        "trading_hub"		  : value("TRADING_HUB", item),
        "renewable_type"          : value("RENEWABLE_TYPE", item),
...
def get_elements(name, dom):
    return dom.getElementsByTagNameNS(RESOURCE_NS, name)
    ...
    def entry_generator(entries):
        for e in entries:
            yield {
                ...
                "trading_hub":          e["trading_hub"],
                "renewable_type":       e["renewable_type"],
                "value":                e["value"]
                }
